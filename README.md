...
Check [releases](https://github.com/yethu/SetVideoSpeed/releases) or click [here](https://github.com/yethu/SetVideoSpeed/releases/download/v1.3.0/SetVideoSpeed_v1.3.0.crx) to download latest packed extension.
